...
<head>
    ...
    <title>À propos - {{ \App\Models\Setting::singleton()->site_name }}</title>
...
<body class="bg-gray-50 text-gray-900 p-8">
    <div class="max-w-4xl mx-auto bg-white shadow rounded-lg p-8">
        ...
        <!-- Updated color here -->
        <h1 class="text-3xl font-bold mb-6 text-[#6fbf44]">À propos</h1>
        
        <div class="prose max-w-none">
            {!! \App\Models\Setting::singleton()->about_content ?? '<p>Contenu non défini.</p>' !!}
        </div>
